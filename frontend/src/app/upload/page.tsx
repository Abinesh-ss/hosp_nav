...
export default function UploadPage() {
    ...
    return (
        <section className="flex min-h-[calc(100vh-64px)] items-center justify-center p-4 bg-gray-100">
            <div className="w-full max-w-4xl rounded-xl bg-white p-8 shadow-2xl border border-gray-100">
                
                <h3 className="text-2xl font-bold mb-8 text-center text-gray-800">Map File Uploader 📄</h3>

                <div className="flex gap-8">
                    {/* Left Panel: Dropzone (Matching image_3759b8.png style) */}
                    <div 
                        ...
                        style={{ borderColor: 'rgb(var(--color-primary-rgb))', minHeight: '300px' }}
                    ...
                    <div className="w-1/2">
                        ...
                        <div className="space-y-4 max-h-[300px] overflow-y-auto pr-2"> {/* Added pr-2 for scrollbar spacing */}
                        ...
                        <button
                            className="mt-6 w-full inline-flex items-center justify-center rounded-md text-sm font-medium h-10 px-4 py-2 bg-green-600 text-white hover:bg-green-700 disabled:bg-gray-400"
